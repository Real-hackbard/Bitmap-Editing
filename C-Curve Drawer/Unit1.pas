...
type
  TForm1 = class(TForm)
    ...
    procedure TracerC(xA, yA, xB, yB, p : Integer);
...
procedure TForm1.TracerC(xA, yA, xB, yB, p : Integer);
var
  xC, yC : Integer;
begin
  ...
  begin
    xC := round(xA + (xB - xA)/2 - (yB - yA)/2);
    yC := round(yA + (yB - yA)/2 + (xB - xA)/2);
    TracerC(xA, yA, xC, yC, p - 1);
    TracerC(xC, yC, xB, yB, p - 1);
  end;
end;
...
begin
  ...
  try
    ...
    TracerC(Label1.Left+3, Label1.Top+7,
