...
uses
  ...
  Vcl.ComCtrls, Vcl.Shell.ShellCtrls, Vcl.Menus, Vcl.StdCtrls, Vcl.ExtCtrls;
...
procedure TForm1.D18Click(Sender: TObject);
var
  b:integer;
  ausw:integer;
  h,h1,h2:integer;
...
begin
    ...
    bitmap.Canvas.textout(bitmap.width-25,120,'Element Size');
